...
export SHAPEFILE="/mnt/data/ala/data/layers/raw/lakepoly.shp"
export LAYERID="5"
export LAYER_SHORT_NAME="lakepoly"
export LAYER_DISPLAY_NAME="UK Lakes"
export FIELDSSID="OSNAME"
...
&& ogr2ogr -lco ENCODING=UTF-8  -s_srs EPSG:27700 -t_srs EPSG:4326  "${REPROJECTEDSHAPEFILE}" "${SHAPEFILE}" \
